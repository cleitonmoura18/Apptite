...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { quantidade: @pedido.quantidade, valor: @pedido.valor } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { quantidade: @pedido.quantidade, valor: @pedido.valor } }
